 ...
 */
final class Version20220114123851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (identifier NVARCHAR(32) NOT NULL, name NVARCHAR(128) NOT NULL, secret NVARCHAR(128), redirect_uris VARCHAR(MAX), grants VARCHAR(MAX), scopes VARCHAR(MAX), active BIT NOT NULL, allow_plain_text_pkce BIT NOT NULL, id NVARCHAR(36) NOT NULL, site_id NVARCHAR(36) NOT NULL, PRIMARY KEY (identifier))');
        $this->addSql('CREATE UNIQUE INDEX siteId ON client (site_Id) WHERE site_Id IS NOT NULL');
        $this->addSql('EXEC sp_addextendedproperty N\'MS_Description\', N\'(DC2Type:oauth2_redirect_uri)\', N\'SCHEMA\', \'dbo\', N\'TABLE\', \'client\', N\'COLUMN\', redirect_uris');
        $this->addSql('EXEC sp_addextendedproperty N\'MS_Description\', N\'(DC2Type:oauth2_grant)\', N\'SCHEMA\', \'dbo\', N\'TABLE\', \'client\', N\'COLUMN\', grants');
        $this->addSql('EXEC sp_addextendedproperty N\'MS_Description\', N\'(DC2Type:oauth2_scope)\', N\'SCHEMA\', \'dbo\', N\'TABLE\', \'client\', N\'COLUMN\', scopes');
        $this->addSql('ALTER TABLE client ADD CONSTRAINT DF_C7440455_C97075B7 DEFAULT \'0\' FOR allow_plain_text_pkce');

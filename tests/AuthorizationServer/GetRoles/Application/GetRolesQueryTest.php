...
final class GetRolesQueryTest extends IntegrationTestCase
{
    private GetRolesQueryInterface $query;
    ...
    protected function setUp(): void
    {
        ...
        $this->query = $container->get(GetRolesQueryInterface::class);

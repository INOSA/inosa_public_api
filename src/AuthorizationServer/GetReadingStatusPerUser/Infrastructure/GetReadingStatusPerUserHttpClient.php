...
use App\AuthorizationServer\GetReadingStatusPerUser\Domain\GetReadingStatusPerUserHttpClientInterface;
...
final class GetReadingStatusPerUserHttpClient implements GetReadingStatusPerUserHttpClientInterface
{
    ...
    {
        $response = $this->httpClient->post($endpoint->getUrl(), $endpoint->getParams());
